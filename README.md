...
- **stats.md**: a GitHub style contribution heatmap, per-habit health and streaks, flaky tests called out with their numbers, and regressions (a habit that used to hold and has started breaking). Every day already behind you carries at least a faint dot, so the twelve weeks have a shape: the dot is the graph paper, never a red square for a day you were not there. The coverage line below says how many such days there were.
