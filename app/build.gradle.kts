...
android {
    namespace = "com.callbackdev.thabit"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.callbackdev.thabit"
        // 33 (Android 13): the series' floor — system per-app language picker for
        // the IT/EN l10n, single runtime path for POST_NOTIFICATIONS (Fase 9),
        // themed icons, full java.time.
        minSdk = 33
        targetSdk = 36
        versionCode = 1
        versionName = "0.1.0"
    ...
    signingConfigs {
        ...
        val releaseStore = findProperty("THABIT_KEYSTORE") as String?
        val releaseStorePassword = findProperty("THABIT_KEYSTORE_PASSWORD") as String?
        val releaseKeyAlias = findProperty("THABIT_KEY_ALIAS") as String?
        val releaseKeyPassword = findProperty("THABIT_KEY_PASSWORD") as String?
    ...
    buildTypes {
        debug {
            ...
            // relabels the launcher icon "thabit (dev)" to tell the two apart.
