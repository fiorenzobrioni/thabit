package com.callbackdev.thabit.ui.theme
...
fun Modifier.editorBorder(shape: Shape = MaterialTheme.shapes.small): Modifier =
    border(1.dp, ThabitTheme.syntax.border, shape)
 ...
 */
@Composable
fun Modifier.fabGlow(color: Color = ThabitTheme.syntax.glow): Modifier = drawBehind {
    val blur = 15.dp.toPx()
