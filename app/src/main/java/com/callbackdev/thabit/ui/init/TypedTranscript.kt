...
/**
 * The transcript of `$ thabit init`, printed instead of pasted (Fase 19).
 *
 ...
 * `HELP.md` takes (Fase 18), for a sharper reason: a cursor walking off the right
 ...
 *
 * The latch is a [rememberSaveable]: `> add your first habit` swaps the whole shell
 * for the wizard, and a rotation on the way there — or a back out of it — that made
 * the intro type itself again would turn a good first second into an obstacle.
 */
@Composable
