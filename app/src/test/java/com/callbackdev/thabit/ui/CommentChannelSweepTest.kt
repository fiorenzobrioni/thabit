 ...
 * which is exactly what went wrong three times during Fase 15: a sweep by hand kept
...
class CommentChannelSweepTest {
     ...
     * "it is a comment" is not one — that was the belief Fase 15 corrected.
     */
    private val allowed: Map<String, String> = mapOf(
        "// thabit editor canvas" to
